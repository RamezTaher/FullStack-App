...
const Features = () => {
  const { data, loading } = useFetch(
    "http://localhost:8800/api/hotels/countByCity?cities=ramez"
  )
    ...
    <>
      {loading ? (
        ...
        <div className="w-full max-w-6xl flex justify-between gap-5 z-10">
          <div className="relative text-white overflow-hidden rounded-md h-[250px] cursor-pointer ">
            <img
          ...
          <div className="relative text-white overflow-hidden rounded-md h-[250px] cursor-pointer">
            ...
            />
            <div className="absolute bottom-5 left-5">
              <h1 className="text-2xl font-bold ">Nabel</h1>
